...
bindd("SUPER", "Return", "Launch Terminal", "exec", "alacritty")
bindd("SUPER SHIFT", "Return", "Launch Terminal (float)", "exec", "alacritty --class alacritty-float")
bindd("SUPER", "Q", "Close Active Window", "killactive", "")
bindd("SUPER SHIFT", "Q", "Exit Hyprland", "exit", "")
bindd("SUPER", "T", "Launch FIle Mgr", "exec", "alacritty -e yazi")
...
bindd("SUPER", "S", "Take screenshot", "exec", "hyprshot -m output -o ~/Pictures/Screenshots")
...
bindd("SUPER", "L", "Lock screen", "exec", "noctalia-msg session lock")
